...
HD_PWD='C:/Users/nelso/OneDrive/Documents/GitHub/Egg-Timer/EggD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EggD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EggD.tcl -notrace
