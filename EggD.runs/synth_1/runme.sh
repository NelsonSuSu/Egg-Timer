...
HD_PWD='C:/Users/nelso/OneDrive/Documents/GitHub/Egg-Timer/EggD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EggD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EggD.tcl
