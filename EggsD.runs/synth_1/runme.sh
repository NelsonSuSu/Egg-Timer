...
HD_PWD='C:/Users/nelso/OneDrive/Documents/GitHub/Egg-Timer/EggsD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EggsD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EggsD.tcl
