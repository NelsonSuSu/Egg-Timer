...
HD_PWD='C:/Users/nelso/OneDrive/Documents/GitHub/Egg-Timer/EggsD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EggsD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EggsD.tcl -notrace
