...
#
# Generated by Vivado on Mon Mar 23 22:04:02 -0400 2020
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../EggD.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../EggD.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../EggD.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
