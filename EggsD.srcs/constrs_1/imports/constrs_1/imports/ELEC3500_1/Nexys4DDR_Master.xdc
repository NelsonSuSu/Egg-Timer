...
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { finished }]; #IO_L8P_T1_D11_14 Sch=led[3]
...
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
...
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { beep }]; #IO_L6P_T0_15 Sch=aud_sd
